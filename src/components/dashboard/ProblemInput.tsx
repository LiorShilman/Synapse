...
const CATEGORIES = [
  ...
  },
  {
    ...
    color: '#80CBC4',
    examples: [
      'לשכור או לקנות דירה — מה עדיף בשלב הנוכחי?',
      'האם לעבור עיר בשביל איכות חיים טובה יותר?',
      'רכב פרטי או תחבורה ציבורית — מה משתלם יותר?',
      'האם כדאי לעבור לתזונה צמחונית?',
    ],
  },
  {
    id: 'family',
    ...
    color: '#F48FB1',
    examples: [
      'בית ספר ממלכתי או פרטי — מה עדיף לילדים?',
      'האם לשלוח ילד לפעילות נוספת או לתת לו זמן חופשי?',
      'טיול משפחתי בארץ או בחו"ל — מה שווה יותר?',
      'איך לחלק זמן בין עבודה למשפחה בצורה מאוזנת?',
    ],
  },
  {
    id: 'finance',
    ...
    color: '#AED581',
    examples: [
      'לחסוך או להשקיע — מה עדיף בגיל 30?',
      'קרן השתלמות או תיק השקעות עצמאי?',
      'האם כדאי לקחת משכנתא עכשיו או לחכות?',
      'ביטוח חיים — האם זה באמת שווה את הכסף?',
    ],
  },
  {
    id: 'health',
    ...
    color: '#EF5350',
    examples: [
      'אימון בבית או חדר כושר — מה יעיל יותר לטווח ארוך?',
      'דיאטה מובנית או אכילה אינטואיטיבית?',
      'האם כדאי לעבור לעבודה מהבית בשביל הבריאות הנפשית?',
      'מדיטציה או פעילות גופנית — מה מפחית יותר מתח?',
    ],
  },
];
