            ...
            <div className="guide-network-visual">
              <svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg" className="guide-network-svg">
                ...
                <g opacity="0.12" strokeWidth="1">
                  ...
                  <line x1="330" y1="80" x2="70" y2="80" stroke="#CE93D8"/>
                  <line x1="330" y1="80" x2="200" y2="170" stroke="#CE93D8"/>
                  <line x1="330" y1="80" x2="330" y2="140" stroke="#CE93D8"/>
                  <line x1="330" y1="80" x2="70" y2="140" stroke="#CE93D8"/>
                  <line x1="70" y1="80" x2="200" y2="170" stroke="#FFAB40"/>
                  <line x1="70" y1="80" x2="330" y2="140" stroke="#FFAB40"/>
                  <line x1="70" y1="80" x2="70" y2="140" stroke="#FFAB40"/>
                  <line x1="200" y1="170" x2="330" y2="140" stroke="#66BB6A"/>
                  <line x1="200" y1="170" x2="70" y2="140" stroke="#66BB6A"/>
                  <line x1="330" y1="140" x2="70" y2="140" stroke="#EF9A9A"/>
                </g>
                {/* Nodes */}
                {[
                  { x: 200, y: 30, color: '#4FC3F7', label: 'אורקל' },
                  { x: 330, y: 80, color: '#CE93D8', label: 'נקסוס' },
                  { x: 70, y: 80, color: '#FFAB40', label: 'פורג׳' },
                  { x: 200, y: 170, color: '#66BB6A', label: 'אקו' },
                  { x: 330, y: 140, color: '#EF9A9A', label: 'סייפר' },
                  { x: 70, y: 140, color: '#FFD54F', label: 'סייג׳' },
                ].map((n) => (
                  <g key={n.label}>
            ...
            <div className="guide-section">
              ...
              <div className="guide-flow-compact">
                {[
                  ...
                  { num: '2', title: 'יצירת מחשבה', desc: 'סימולציה או Claude API אמיתי', color: '#CE93D8' },
                  { num: '3', title: 'שיתוף', desc: 'שליחה ל-1-2 סוכנים + אנימציה', color: '#FFAB40' },
